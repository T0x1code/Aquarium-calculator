        ...
        **Для {c_vol:.0f} л осмосу додай:**
        ...
        with st.expander("📖 Інструкція приготування", expanded=True):
            ...
            2. **Додайте солі** в такому порядку:
               - 🧂 **$CaCl_2 \\cdot 2H_2O$ (кальцій хлорид)** — додайте першим, розмішати до повного розчинення
               - 🧂 **$MgSO_4 \\cdot 7H_2O$ (магній сульфат)** — добре розчиняється
               - 🧂 **$CaCO_3$ (кальцій карбонат)** — Зверніть увагу!!! CaCO₃ погано розчиняється у воді без подачі вуглекислого газу, тому вода стане молочно-білою. Це нормальна реакція.
